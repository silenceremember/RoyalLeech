...
/// <summary>
/// Shader-based shadow for UI elements using mesh modification.
/// Works universally with Simple, Sliced, Tiled sprites and solid rectangles.
/// Adds shadow geometry directly to the Image mesh for single draw call.
/// </summary>
[RequireComponent(typeof(Graphic))]
[ExecuteAlways]
public class ShaderShadow : MonoBehaviour, IMeshModifier
{
    ...
    void CreateMaterialInstance()
    {
        ...
        if (_graphic.material != null && _graphic.material.shader.name == "Custom/UIShadow")
        {
